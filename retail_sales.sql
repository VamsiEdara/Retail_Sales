...
# What are different categories available?
...
SELECT
	category,
	SUM(total_sale) AS Net_Sales_By_Category,
...
ORDER BY 1; # order by 1 indicates ==> category, order by 2 indicates ==> gender
...
SELECT 
	category,
	COUNT(DISTINCT(customer_id)) AS Total_cust_Purchased
FROM retail_sales
GROUP BY category;
